<%@page import="in.co.mobile.store.entity.UserEntity"%>
              ...
              <div class="site-top-icons">
                ...
                <%if(userbean!=null){ %>
                  ...
                  <li><a href="<c:url value = "/login"/>"><span class="glyphicon glyphicon-log-out"></span>LogOut</a></li>
           		   <%}else{%> 
           		   <li><a href="<c:url value = "/listcategory"/>"><span class="glyphicon glyphicon-log-in"></span>Category</a></li>
        ...
        <div class="container">
          ...
          <%if(userbean!=null){ %>
           ...
           <%if(userbean.getRoleId()==1){ %>
             ...
             <li><a href="/category/search">Category List</a></li>
              <li><a href="/prod">Add Product</a></li>
              <li><a href="/prod/search">Product List</a></li>
             <li><a href="/bookProd/search">Booked List</a></li>
              
            <%}else{ %>
            <li><a href="/bookProd/search">Book Product</a></li>
            <%} %>
            <%}%>
